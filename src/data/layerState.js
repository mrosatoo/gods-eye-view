...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ id: 'emsc-quakes', token: 'j', disposition: 'enabled-only' }),
  Object.freeze({ id: 'flights', token: 'f', disposition: 'enabled+options', optionOwner: 'flights' }),
  Object.freeze({ id: 'gdacs-alerts', token: 'h', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'marine-weather', token: 'k', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'nws-alerts', token: 'n', disposition: 'enabled-only' }),
  Object.freeze({ id: 'portwatch', token: 'p', disposition: 'enabled-only' }),
