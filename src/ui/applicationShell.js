  ...
  _initGlobalContextPanel() {
    ...
    this._contextControls = new ContextControls({
      elements: {
        ...
        _globalContextDisruptionBtn: this._globalContextDisruptionBtn,
        ...
        _contextDisruptionView: this._contextDisruptionView,
        _disruptionStripHost: this._disruptionStripHost,
